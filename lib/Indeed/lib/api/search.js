...
var JobSearch = module.exports = function (domain, publisherId) {
	...
	this.Highlight = function (bool) {
		if (typeof bool === "boolean")
			...
			throw "bool must be a boolean value!";
	...
	/**
		* Sets the result number at which results should start.
		* Allows for searching through multiple pages of results.
	*/
	...
	this.WhereCountry = function (country) {
		...
		if (countries[country])
			...
			throw (country + ' is not a value country code. Reference indeed api documentation for allowed values.');
        ...
        if(validateRequiredFields())
        {
            ...
            request(url, function (error, response, body) {
              if(error){
                ...
                // handling for 400 & 500 error codes.
              }
            });
        }
    };
